...
- #041 — fix: model router changes not persisted to config.json: Change onSave callback to accept RouterState and sync router mutations into ConfigManager before writing. Files: router.ts, index.ts, runtime.ts, procedures.ts
