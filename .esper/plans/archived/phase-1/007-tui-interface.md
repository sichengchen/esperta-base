...
## Progress
- Implemented App, ChatView, Input, StatusBar, ModelPicker components
- Wired up Agent streaming in App with real-time token display
- Model switching via Ctrl+M or /model command
- Entry point loads config, memory, router, agent, renders TUI
- Modified: src/tui/App.tsx, src/tui/ChatView.tsx, src/tui/Input.tsx, src/tui/StatusBar.tsx, src/tui/ModelPicker.tsx, src/tui/index.ts, src/index.ts
- Verification: passed — typecheck clean, 56 tests pass
