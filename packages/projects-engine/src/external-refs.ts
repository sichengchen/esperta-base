...
export function buildExternalRefId(ownerType: ExternalRefRecord["ownerType"], ownerId: string, system: ProjectsExternalSystem, externalId: string): string {
...
export function findThreadRefsByLinearIssueId(repository: ProjectsEngineRepository, linearIssueId: string): ExternalRefRecord[] {
